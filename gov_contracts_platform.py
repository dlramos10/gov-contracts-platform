...
# Set current date and time (07:48 PM EDT, June 09, 2025)
current_datetime = datetime.datetime(2025, 6, 9, 19, 48, tzinfo=datetime.timezone(datetime.timedelta(hours=-4)))  # EDT is UTC-4
